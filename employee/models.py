...
class EmployeeDetail(models.Model):
    ...
    image = models.FileField(upload_to="Employee Profile Picture/", null=True, default=None)
...
class Career(models.Model):
    ...
    phone = models.CharField(max_length=12)
    date = models.DateField(null=True)
    file = models.FileField(upload_to="Job Application/", null=True, default=None)
