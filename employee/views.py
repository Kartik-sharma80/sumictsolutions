...
def career(request):
    ...
    if request.method == "POST":
        ...
        try:
            Career.objects.create(email=email, phone=phone, file=file, date=datetime.today())
            error = "no"
        except:
            error = "yes"

    d = {'error': error}
    return render(request, 'career.html', d)
...
def emp_home(request):
    ...
    d = {'employee': employee}
    return render(request, 'emp_home.html', d)
...
def myexperience(request):
    ...
    d = {'experience': experience, 'employee': employee}
...
def myeducation(request):
    ...
    d = {'education': education, 'employee': employee}
...
def all_query(request):
    ...
    return render(request, 'all_query.html', locals())
...
def all_career_application(request):
    if not request.user.is_authenticated:
        return redirect('admin_login')
    career = Career.objects.all()
    return render(request, 'all_career.html', locals())


def delete_career_application(request, pid):
    if not request.user.is_authenticated:
        return redirect('admin_login')
    career = Career.objects.get(id=pid)
    career.delete()
    return redirect('all_career_application')